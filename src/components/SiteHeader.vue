  ...
  <header :class="['header', { 'internal': internal }]">
    ...
    <a href="/" :class="['logo', { 'logo--inverse': internal }]">
      <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 1400.2 334"
        style="enable-background:new 0 0 1400.2 334;"
        xml:space="preserve"
      >
        <g>
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M802.6,78.7c-4.4,0-8.3,2-11.7,6c-3.1,3.4-4.6,6.7-4.6,9.7c0,0.4,0.1,0.9,0.3,1.5
		...
		c-0.2-3.8-2.2-6.2-6-7.1C805.9,83.8,803.6,81.7,802.6,78.7z"
          ...
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M1148,78.7c-4.4,0-8.3,2-11.7,6c-3.1,3.4-4.6,6.7-4.6,9.7c0,0.4,0.1,0.9,0.3,1.5
		c0.4,2.8,2.3,6,5.7,9.4c2.9,3,6.1,4.6,9.7,4.6c0.6,0,1.2-0.1,1.7-0.3c4-0.4,7-2.6,8.9-6.6c1.9-3.6,2.9-7,2.9-10V92
		c-0.2-3.8-2.2-6.2-6-7.1C1151.2,83.8,1149,81.7,1148,78.7z"
          ...
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M622.4,274.2c-5.9-4.4-11.3-9.6-16.3-15.7c-1.5-1.9-3.1-3.7-4.6-5.4c0.4-0.8,0.9-1.6,1.5-2.3
		...
		c-2.7,14.5-6.4,27.3-11.2,38.8C598.5,244.8,597.8,246.3,597,247.8z"
          ...
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M1396,199.2c-1.6-0.2-3.1,0.2-4.6,1.1c-2.3,4.8-5.1,10.3-8.3,16.5c-3.2,6.1-6.6,12.2-10,18.3
        ...
        <g id="XMLID_28_">
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M163.6,328.2c64.5,14.8,161,5.7,190.6-80.8c9.6-28.1,10.6-51.4,5.8-71.3
		...
		c0-0.1-0.1-0.2-0.1-0.4c-1.1,18.5,2.7,34.2,7.6,46.9C30.3,257.3,109.9,315.8,163.6,328.2z"
          ...
          <path
            ...
            fill="currentColor"
            class="logo-element"
            d="M337.4,76.7c14.8-6.6,26.9-1.6,35.3,11.6C376.5,64,345.3,58,337.4,76.7z"
          ></path>
          <path
            id="XMLID_29_"
            fill-rule="evenodd"
            ...
            fill="currentColor"
            class="logo-element"
            d="M452.6,117.8c-11.3-0.7-18.2-2.1-31.2-13c-2,11.5-6.1,20.7-12.2,27.7
